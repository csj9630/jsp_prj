...
$(function(){
	...
	$("#btnXML").click(function(){
		$.ajax({
			...
			//xml에서 msg을 찾아서 text로 parsing 한다.
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					...
					<input type="button" value="TEXT요청" class="btn btn-info" id="btnText">
					<input type="button" value="XML요청" class="btn btn-primary" id="btnXML">
					<input type="button" value="JSON요청" class="btn btn-danger" id="btnJSON">
					<div id="output"></div>					
				</div>
