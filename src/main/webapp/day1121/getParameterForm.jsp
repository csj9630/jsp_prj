...
<div id="joinFrmDiv">
	...
	<table id="joinFrm">
		<tr>
			...
			<td class="input"><input type="text" class="inputBox" name="id" value="test11sdfdf2123g"/></td>
		</tr>
		...
		<tr>
			...
			<td class="input">
				<select name="loc" class="inputBox" style="width: 120px;height: 25px">
	...
	<hr><!-- ------------------POST방식---------------------------------------------------- -->
	<form name="joinFrm" id="joinFrm2" method="POST" action="getParameterFormProcess.jsp">
	<table id="joinFrm">
		<tr>
			<td class="title"><label><span class="star">*</span>아이디</label></td>
			<td class="input"><input type="text" class="inputBox" name="id" value="test11sdfdf2123g"/></td>
