  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					<!-- 객체가 생성된다. -->
					<!-- 기본 생성자를 사용하여 객체가 생성된다. -->
					<jsp:useBean id="dDTO" class="day1127.DataDTO" />
					<%=dDTO %>
					<!-- setter method 호출 값 :setName, setMyAge-->
					<jsp:setProperty property="name" name="dDTO" value="제임스"/>
					<jsp:setProperty property="myAge" name="dDTO" value="26"/>
					<jsp:getProperty property="name" name="dDTO"/>
					<jsp:getProperty property="myAge" name="dDTO"/>
				</div>
				<%
