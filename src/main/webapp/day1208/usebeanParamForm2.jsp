		...
		function idDup(id) {
			...
			$.ajax({
				...
				success :function(jsonObj){
					console.log(jsonObj.idResult);
					$("#idWarning").html(jsonObj.idResult? "사용가능":"이미사용중");
					...
					<form name="joinFrm" method="post" id="joinFrm"
						...
						<table id="joinFrm">
							<tr>
								...
								<td class="input"><input type="text" class="inputBox"
									name="id" id="id" /> <input type="button"
									value="중복확인" class="btn btn-success btn-sm" id="btnSearch" />
									<div id="idWarning">중복확인</div>
									</td>
							...
							<tr>
								...
								<td class="input"><input type="password" class="inputBox"
									name="pass" value="minjo123" /></td>
							</tr>
							...
							<tr>
								...
								<td><textarea name="intro"
										style="width: 400px; height: 100px">내소개</textarea></td>
							</tr>
							<tr>
								<td class="title">관심언어</td>
								<td><input type="checkbox" name="language" value="java" />
									자바 <input type="checkbox" name="language" value="C" /> C/C++ <input
									type="checkbox" name="language" value="visual basic" />비주얼베이직 <input
									type="checkbox" name="language" value="PyThon" />파이썬 <input
									type="checkbox" name="language" value="PHP" />PHP <input
									type="checkbox" name="language" value="JSP" />JSP</td>
							</tr>
							<tr>
								<td colspan="2" style="text-align: center"><input
									type="hidden" name="code" value="U3881"> <input
									type="button" value="값 전송" class="btn btn-success" id="btn" />
								</td>
							</tr>
						</table>
					</form>
