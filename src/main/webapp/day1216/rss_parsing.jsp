	...
	if( confirm(title+" 기사를 보시겠습니까?") ){
		$.ajax({
			...
			success: function( xmlDoc ){
				...
				output+=" 기사 : <strong>"+ itemNodes.length +"</storng>건<br>";
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					...
					list.add(new RssDTO("section/entertainment", "연애", "entertainment"));
					...
					//CORS 이슈로 인하여 RSS을 java에서 읽어 들여 XML fille로 생성.
					//뉴스의 전처리
					for (RssDTO rDTO : list) {
						ae.createRss(rDTO.getUrl(), rDTO.getEngTitle());
					} //end for

					//String commonURL = "https://news-ex.jtbc.co.kr/v1/get/rss";
					...
					<table class="table table-hover">
						<tr>
							<c:forEach var="news" items="${rssList}">
								<td><a
									href="javascript:requestRss('${commonURL }/day1216/${news.engTitle}','${news.engTitle}')"><c:out
