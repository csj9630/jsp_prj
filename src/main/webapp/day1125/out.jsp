  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
				<%
//				String[] url = "http://youtube.com,https://www.naver.com/,https://github.com/csj9630?tab=repositories".split(",");
				String[] url = {"http://youtube.com","https://www.naver.com/","https://github.com/csj9630?tab=repositories"};
				...
				//url로 a 태그 만들어서 제공할 때는 expression 쓰는 게 편하다.
				//태그랑 속성에 값 넣어서 출력할 때는 표현식이 좋다.
				for (String printUrl : url){
					//expression을 사욘한 출력
