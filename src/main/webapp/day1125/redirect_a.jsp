...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" info="정상적인 응답페이지 - 비정상적 요청 발생 시 리다이렉트 방법"%>
...
<head>
<%
session.setAttribute("name", "탈모탄조");

//랜덤으로 비정상적 요청 상황을 만든다.
if(new Random().nextBoolean()){//로그인이 안된 상황 발생(세션이 존재 안함)
	//비정상적 요청이 발생했을 때 b.jsp를 호출한다ㅣ.
	
	//meta 태그로 2초 후 url로 redirect. 
	%>
	<meta http-equiv="refresh" content="2;redirect_b.jsp">
<!-- 	<script type="text/javascript">
	location.href="redirect_b.jsp";
	</script> -->
	<%	
	// 	response.sendRedirect("redirect_b.jsp");
//	return;//redirect를 해도 아랫줄 코드는 그대로 실행되므로 return도 같이 쓰기
	
}//end if
	//정상 상황이면 하단 페이지를 실행한다.
  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				정상적인 응답<br>
				<img src="images/redirect.png" alt="M자탈모 스플래쉬ㅣㅣㅣ"/>
