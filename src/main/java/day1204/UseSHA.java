...
public class UseSHA {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//4. 문자열로 생성(사람이 알아볼 수 있는 문자열로 인코딩.)
			...
			//평문을 바로 암호화 후 인코딩하는 외부 라이브러리 사용.
